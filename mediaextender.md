...
![UrlCopy](./images/mediaextender/media-extender2.jepg)
3. Cole no input url do form.
![UrlPaste](./images/mediaextender/media-extender3.jepg)
4. Clique em atualizar e a nova url será copiada para area de transferencia.
![UrlMsg](./images/mediaextender/media-extender4.jepg)
5. Cole a url copiada na barra de endereço do navegador e acesse.
![UrlBar](./images/mediaextender/media-extender5.jepg)
